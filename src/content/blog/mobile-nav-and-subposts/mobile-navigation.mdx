...
<div class="grid grid-cols-2 gap-4 [&_img,p,.expressive-code]:m-0">
  <div>
...
```javascript title="src/components/TOCMobile.astro" startLineNumber={123}
...
```javascript title="src/components/TOCMobile.astro" startLineNumber={216}
