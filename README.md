...
| [phannhat.id.vn](https://phannhat.id.vn) | [@f1rst](https://github.com/phannhat17)          | A research-focused personal blog sharing projects, experiments, and insights in programming and cybersecurity. | The original repository includes password-protected posts, so the source code is not publicly available. |
